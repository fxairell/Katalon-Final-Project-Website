...
WebUI.setText(findTestObject('Register Now Page/txt_Password'), 'lower')

WebUI.setText(findTestObject('Register Now Page/txt_Confirm Password'), 'lower')
...
WebUI.verifyElementPresent(findTestObject('Register Now Page/prompt_Password must be at least 8 characters'), 0)
