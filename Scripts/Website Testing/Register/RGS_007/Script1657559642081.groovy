...
WebUI.setText(findTestObject('Register Now Page/txt_Email Address'), 'janedoe')
...
WebUI.setText(findTestObject('Register Now Page/txt_Confirm Password'), '1Capital1lower')
...
WebUI.verifyElementPresent(findTestObject('Register Now Page/prompt_Incorrect Email'), 0)
