...
WebUI.setText(findTestObject('Register Now Page/txt_Password'), 'Capitallower')
...
WebUI.verifyElementPresent(findTestObject('Register Now Page/prompt_Password Compotition'), 0)
