...
WebUI.setText(findTestObject('Register Now Page/txt_Username'), 'johndoe')
...
WebUI.verifyElementPresent(findTestObject('Register Now Page/prompt_Incorrect Username'), 0)
