...
WebUI.setText(findTestObject('Checkout Page/Shipping Information/txt_Email'), 'janedoe')
...
WebUI.verifyElementPresent(findTestObject('Checkout Page/Shipping Information/prompt_Invalid Email'), 0)
