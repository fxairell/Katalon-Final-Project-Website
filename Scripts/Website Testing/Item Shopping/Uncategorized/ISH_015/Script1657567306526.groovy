...
WebUI.click(findTestObject('Shop Page/Shop Category/btn_Uncategorized'))

WebUI.click(findTestObject('Shop Page/Item/Uncategorized/dsc_Long Sleeve Tee'))
...
} else if (WebUI.verifyElementClickable(findTestObject('Item Page/btn_Add to cart'))) {
